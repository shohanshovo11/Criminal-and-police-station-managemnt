...
<div class="container">
        ...
        <article class="card-body mx-auto" style="max-width: 400px;">
            ...
            <form action="" method="post">
                ...
                <div class="form-group input-group">
                    ...
                    <input type="date" name="datefield" class="form-control" placeholder="Date" value="<?php echo isset($_POST['datefiedl']) ? $_POST['datefield'] : ''; ?>">
                </div>
                <!-- form-group// -->
                <div class="form-group input-group">
                    <div class="input-group-prepend">
                ...
                <div class="form-group input-group">
                    ...
                    <input name="nid" class="form-control" placeholder="NID" type="text" value="<?php echo isset($_POST['nid']) ? $_POST['nid'] : ''; ?>">
                </div>
                <div class="form-group input-group">
                    <div class="input-group-prepend">
    ...
    if (isset($_POST['submit'])) {
        ...
        $plsql = "DECLARE
            v_userid userdb.user_id%TYPE := :userid;
            v_row_count NUMBER;
        ...
        BEGIN
            ...
            ELSE
                IF LENGTH(:phonenum) = 14 AND SUBSTR(:phonenum, 1, 4) = '+880' THEN
                    INSERT INTO userdb (user_id, first_name, middle_name, last_name, phone_no, dob, street, city, district, post_code, nid) 
                    VALUES (:userid, :fname, :mname, :lname, :phonenum, TO_DATE(:dob, 'YYYY-MM-DD'), :street, :city, :district, :postcode, :nid);
                    COMMIT;
    
                    INSERT INTO login VALUES (:userid, :pass, 'G');
                    COMMIT;
                ELSE
