...
$sql = "SELECT * FROM userdb WHERE user_id = :usr";
...
<body>
      ...
      <div class="col-md-6">
        <form class="needs-validation" novalidate method="post">
          <div class="form-row">
            ...
            <div class="col-md-8 mb-3 mx-auto">
              <label for="validationCustonPhone">Phone</label>
              <input type="text" name="phonefield" class="form-control" id="validationCustom02" placeholder="Phone No" value="<?php echo $phone; ?>" required>
            </div>
            <div class="col-md-8 mb-3 mx-auto">
            ...
            <div class="col-md-8 mb-3 mx-auto">
              ...
              <div class="input-group">
                ...
                <input type="text" name="useridfield" class="form-control" id="validationCustomUsername" placeholder="Username" aria-describedby="inputGroupPrepend" value="<?php echo $userid; ?>" readonly required>
              </div>
            </div>
            <div class="col-md-8 mb-3 mx-auto">
  ...
  if (isset($_POST['submit'])) {
    ...
    // echo "$nfname $nmname $nlname $nphone $ndob $nuserid $nstreet $ncity $ndistrict $npost<br>";
    $conn = oci_connect('shohan', '123', '//localhost/XE');
    // Check connection
    if (!$conn) {
      echo 'Failed to connect to oracle' . "<br>";
    ...
    //query to fetch data
    $query = "update userdb set first_name=:val2 ,middle_name=:val3,last_name=:val4,phone_no=:val5,dob=to_date(:val6,'yyyy-mm-dd'),
    street=:val7,city=:val8,district=:val9,post_code=:val10 where user_id=:usr";
    ...
    oci_bind_by_name($stid, ":val5", $nphone);
